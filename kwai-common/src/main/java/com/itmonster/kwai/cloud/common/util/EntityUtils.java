package com.itmonster.kwai.cloud.common.util;
...
public class EntityUtils {
    ...
    public static <T> void setCreateInfo(T entity) {
        ...
        // 默认值
        Object[] value = null;
        value = new Object[]{name, id, hostIp, DateUtil.now()};
        // 填充默认属性值
    ...
    private static <T> void setDefaultValues(T entity, String[] fields, Object[] value) {
        if (ReflectionUtils.hasField(entity, "id") && ReflectionUtils.getFieldValue(entity, "id") != null) {
            ReflectionUtils.invokeSetter(entity, "id", UUID.fastUUID());
        }
